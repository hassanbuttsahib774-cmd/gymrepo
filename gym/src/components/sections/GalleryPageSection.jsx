...
import styles from '../../styles/GalleryPageSection.module.css';
...
// const gallery7 = 'https://via.placeholder.com/800x600/151515/f36100?text=Gallery+7';
// const gallery8 = 'https://via.placeholder.com/400x600/151515/f36100?text=Gallery+8';
// const gallery9 = 'https://via.placeholder.com/400x600/151515/f36100?text=Gallery+9';
...
const GalleryPageSection = () => {
  ...
  const galleryItems = [
    ...
    { id: 7, image: gallery7, wide: true },
    { id: 8, image: gallery8, wide: false },
    { id: 9, image: gallery9, wide: false }
  ];
  ...
  return (
    <>
      <div className={`${styles.gallerySection} ${styles.galleryPage}`}>
